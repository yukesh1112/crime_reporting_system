...
<head>
    ...
    if (isset($_POST['s'])) {
        ...
        // Connect to the database with the database name as the fourth argument
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            // Run the query to check for the user in the database
        ...
        <div class="form" style="margin-top: 15%">
            <form method="post">
                <div class="form-group" style="width: 30%">
                    ...
                    <input type="email" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter user id" required>
                </div>
                <div class="form-group" style="width:30%">
