...
<head>
    ...
    // Check if session is set, redirect if not
    if (!isset($_SESSION['x'])) {
    ...
    // Fetch user's Aadhar number using their user ID
    ...
    if (isset($_POST['s2'])) {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($qn['a_no'] == $q2['a_no']) {
                ...
                echo "<script type='text/javascript'>alert('Not Your Case');</script>";
            }
        }
    }

    // Fetch complaints related to the logged-in user
    ...
    <div style="padding: 50px;">
        <table class="table table-bordered">
            ...
            <?php 
                ...
                <tbody>
                    <tr>
                        <td colspan="4" style="text-align:center;">No complaints found for your Aadhar number.</td>
                    </tr>
                </tbody>
            <?php } ?>
        </table>
